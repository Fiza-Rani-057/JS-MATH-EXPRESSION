...
document.write("Subtraction of " + num1 + " " + "and " + num2 + " " + "is "
    + sub + "<br>");
document.write("Multiplication of " + num1 + " " + "and " + num2 + " " +
    "is " + multiply + "<br>");
document.write(" Division of " + num1 + " " + "and " + num2 + " " +
    "is " + divide + "<br>");
...
document.write("The Cost of buying 5 tickets is " + ticketCost + "PKR");
